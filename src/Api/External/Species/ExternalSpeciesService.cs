...
public class ExternalSpeciesService(IRaceRepository raceRepo, ISubraceRepository subraceRepo, IAbilityRepository abilityRepo, ILogger<ExternalSpeciesService> logger) : IExternalSpeciesService
{
    ...
    private async Task AddAbilityScoreBonusesAsTraitAsync<T>(ESpeciesDto eSpecies, T species, IRepository<T> speciesRepo) where T : Domain.Species.Models.Species
    {
    ...
    // TODO: Parses Traits
    private static void ParseTraits(Domain.Species.Models.Species species)
    {
